            ...
            <div className="w-full h-4/5 rounded-lg bg-primary-color border flex border-text-color">
              ...
              <main className="flex-1 flex">
                ...
                <section className="flex-1 flex">
                  ...
                  <div className="w-1/3 border-l border-l-text-color flex flex-col gap-4 basis-auto max-w-full overflow-y-scroll">
                    <div className="flex justify-between items-center p-5 h-[80.8px] border-b border-text-color">
                      <div className="flex items-center justify-center ml-4">
                        <h4 className="text-white text-lg box-border">
                          Details
                        </h4>
                      </div>
                    ...
                    <div className="flex flex-col gap-2 items-center justify-center">
                      <div className="flex flex-col gap-2 items-center justify-center">
                        ...
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <span className="text-sent-message-color">
                            {" "}
                            Online
                          </span>
                        </div>
